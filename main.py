...
class Network(object):
    ...
    def backprop(self, x, y):
        ...
        # backpropagate through the earlier layers
        # l = 2 means the second-last layer, l = 3 is the third-last, etc.
    ...
    def evaluate(self, test_data):
        ...
        networks output is assumed to be the index of whichever
